      ...
      <div className="relative flex h-full flex-col">
        <div className="flex-col items-start leading-tight tracking-wide">
          ...
          <div className="relative flex-col justify-start py-4 px-6">
            ...
            <div
              ref={cameraBoxRef}
              className={`w-full rounded-md bg-gray-100  text-center outline-dashed outline-gray-300 transition-all ${
                isCameraShown ? "h-96" : "h-60 p-12"
              }`}
            >
              {isCameraShown ? (
                <Webcam
        ...
        <div
          ref={popUpRef}
          className="fixed bottom-0 left-1/2 z-20 h-80 w-full max-w-md -translate-x-1/2 flex-col items-center justify-center rounded-lg bg-white p-8 text-center shadow-2xl"
        >
